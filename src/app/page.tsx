export const revalidate = 0; // ✅ 常に最新を同期
  ...
  return (
    <main className="min-h-screen bg-white text-black font-sans">
      ...
      <section className="py-12 border-b-4 border-black bg-yellow-400">
        <div className="max-w-5xl mx-auto flex flex-wrap justify-center gap-8 font-black text-2xl italic uppercase">
      ...
      <section id="members" className="max-w-7xl mx-auto py-24 px-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Link href="/members" className="group block overflow-hidden border-[6px] border-black bg-black p-12 shadow-[15px_15px_0px_0px_rgba(255,255,0,1)] transition-all hover:translate-x-1 hover:-translate-y-1">
            <h3 className="text-5xl font-black italic text-white tracking-tighter uppercase">View All Members</h3>
